...
class InkUsageDetails extends Component {
  constructor(props) {
    super(props);
    var date = new Date;
  ...
  async getData(startDate, endDate) {
    ...
    let converted = await DataParser.convertInkUsageData(this.state.inkusage);
    let labels = await ImageService.getInkTypesPaginated(
      startDate,
      endDate
    ).then(({ data }) => data);
...
export default InkUsageDetails;
